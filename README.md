...
运行后默认端口 3000，建议始终使用 `http://127.0.0.1:3000`。`127.0.0.1` 与 `localhost` 的浏览器本地画布、素材和配置互不共用。

Windows 新电脑从源码包安装请查看 [Windows 源码安装说明](INSTALL-WINDOWS.md)。
