export default {
    ...
    publicMediaUpload: {
        disabled: "This asset is not public. Enable Public media relay in Preferences first.",
        urlRequired: "Enter the public media relay URL first.",
        urlInvalid: "The public media relay URL is invalid.",
        tokenRequired: "Enter the public media relay token first.",
        readFailed: "Failed to read the local reference asset. Select it again.",
        invalidMedia: "The reference asset has an invalid file type.",
        failed: "The public media relay request failed. The provider request was not sent.",
        missingUrl: "The public media relay did not return a valid URL.",
        invalidResponse: "The public media relay returned incomplete data.",
    },
    wuhen: { disabled: "Enable Wuhen AI in Preferences first.", baseUrlRequired: "Enter the Wuhen AI URL first.", apiKeyRequired: "Enter the Wuhen AI API Key first.", accessTokenMissing: "Wuhen AI did not return an access token.", taskIdMissing: "Wuhen AI did not return a task ID.", requestFailed: "The Wuhen AI request failed.", emptyResponse: "Wuhen AI returned an empty response.", failed: "Subtitle/watermark removal failed.", timeout: "The Wuhen AI task timed out. Query it again from the result node.", downloadFailed: "The processed result could not be saved locally. Check the relay download configuration.", resultTitle: "Subtitle/watermark removal result" },
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", mode: "Mode", modes: { frames: "First & last frame", reference: "General reference" }, resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", negativePrompt: "Negative prompt", negativePromptPlaceholder: "Describe content that should not appear in the video", faceProcessing: "Reference face processing", adaptive: "Adaptive", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    apiErrors: { requestFailed: "Request failed", requestCanceled: "Request canceled", baseUrlRequired: "Configure the Base URL first", apiKeyRequired: "Configure the API key first", authenticationFailed: "Authentication failed. Check the API key, plan permissions, and model permissions.", rateLimited: "The request was rate-limited or the quota is insufficient. Try again later.", notFound: "The endpoint was not found (404). Check the Base URL and selected model.", badGateway: "Gateway error (502). The API service is temporarily unavailable.", serviceBusy: "Service unavailable (503). Try again later.", httpFailed: "Request failed (HTTP {{status}}). Check the Base URL and API key.", htmlError: "The service returned an HTML error page ({{preview}})", audioModelRequired: "Configure an audio model first", audioGenerationFailed: "Audio generation failed", scriptNoAudio: "The model request script did not return audio", geminiAudioUnsupported: "The Gemini API format does not support audio generation. Use an OpenAI-format provider.", invalidImageSizeFormat: "Unsupported image size. Use auto, 9:16, or 1024x1024.", positiveImageRatio: "The image ratio must use positive numbers, such as 9:16.", imageRatioLimit: "The image aspect ratio cannot exceed 3:1. Adjust the dimensions.", positiveImageDimensions: "Image dimensions must be positive integers, such as 1024x1024.", imageDimensionStep: "Image width and height must be multiples of 16.", imageEdgeLimit: "The longest image edge cannot exceed 3840px.", imagePixelLimit: "The total image pixel count must be between 655360 and 8294400.", unknownImageResponse: "The API returned data in an unknown format (fields: {{fields}}). Check model or API compatibility.", noImageReturned: "The API did not return an image. The prompt may have triggered safety review or the model may not support this operation.", geminiRejected: "Gemini rejected the request: {{reason}}", geminiNoImage: "The Gemini API did not return an image", maskModelUnsupported: "This model does not support mask editing. Use another provider.", noContent: "No content returned", modelReadFailed: "Failed to load models", videoTimeout: "{{provider}}video generation timed out. Try again later.", pluginVideoExpired: "The plugin video task has expired. Generate it again.", scriptNoVideo: "The model request script did not return a video", noPlayableVideo: "The video API did not return a playable video", noVideoTaskId: "The video API did not return a task ID", videoTaskCreateFailed: "Failed to create video task", videoGenerationFailed: "Video generation failed", videoTaskQueryFailed: "Failed to query video task", videoPromptRequired: "Enter a video prompt or connect a reference image, video, or audio asset", referenceImageReadFailed: "Failed to read the reference image. Choose another image or upload it again.", invalidReferenceVideo: "A reference video must be a public URL, asset ID, or locally saved video", invalidReferenceAudio: "Reference audio must be a public URL, asset ID, or locally saved audio file", videoModelRequired: "Configure a video model first", geminiVideoUnsupported: "The Gemini API format does not support video generation. Use an OpenAI-format provider.", noVideoTask: "The API did not return a video task", videoDownloadFailed: "Failed to download video", localAssetReadFailed: "Failed to read local asset", capabilityImage: "image", capabilityText: "text", autoDlCapabilityUnsupported: "AutoDL ComfyUI does not support {{capability}} generation", autoDlWorkflowUnknown: "No verified request schema is available for AutoDL workflow {{workflow}}. Provide its API parameters before calling it.", autoDlDurationRange: "This AutoDL workflow supports {{min}}–{{max}} seconds", autoDlImageCount: "This AutoDL workflow requires {{min}}–{{max}} reference images", autoDlAudioCount: "This AutoDL workflow requires {{min}}–{{max}} reference audio files", autoDlRatioUnsupported: "The AutoDL workflow does not support aspect ratio {{ratio}}", autoDlResolutionUnsupported: "The AutoDL workflow does not support {{resolution}}. Supported values: {{supported}}", autoDlVideoReferencesUnsupported: "The configured AutoDL workflows do not accept reference videos", autoDlReferenceImageUrlRequired: "The AutoDL workflow documentation requires a public URL for each reference image. This asset is not public, so no request was sent.", autoDlReferenceAudioUrlRequired: "The AutoDL workflow documentation requires a public URL for each reference audio file. This asset is not public, so no request was sent.", providerModelListUnsupported: "No verified Volcengine Ark model-list endpoint is available. Add model names manually.", ziziImageReferenceUrlRequired: "The verified Zizi Donghua image-to-image API requires public image URLs; local canvas images cannot be sent directly", ziziImageReferenceLimit: "This Zizi Donghua image model supports up to {{max}} reference images", ziziImageReferenceSchemaUnknown: "The reference-image schema for Zizi Donghua model {{model}} is unverified. Provide that model documentation before calling it.", volcengineVideoReferencesUnsupported: "The Volcengine Ark reference-media content schema has not been fully verified. Only text-to-video is currently enabled.", volcengineResolutionUnsupported: "Volcengine Ark video does not support {{resolution}}. Choose 480p, 720p, or 1080p.", ziziReferenceVideoUrlRequired: "Zizi Donghua reference video must use a public URL", ziziReferenceAudioUrlRequired: "Zizi Donghua reference audio must use a public URL", ziziAudioModelSchemaUnknown: "The reference-audio schema for Zizi Donghua model {{model}} is unverified. Choose a model with explicit audio support.", ziziDurationRange: "This Zizi Donghua video model supports {{min}}–{{max}} seconds", ziziVideoReferenceModelRequired: "This Zizi Donghua H3 model does not accept reference video. Choose a video-reference model whose name includes -video.", ziziPromoVideoUnsupported: "The Zizi Donghua promotional H3 series does not support reference video", ziziVideoModelSchemaUnknown: "The video request schema for Zizi Donghua model {{model}} is unverified. Provide that model documentation before calling it.", ziziImageCount: "This Zizi Donghua video model requires {{min}}–{{max}} reference images", ziziAudioCount: "This Zizi Donghua video model requires {{min}}–{{max}} reference audio files", ziziPromoRatioUnsupported: "The Zizi Donghua promotional H3 series does not support 1:1; choose landscape or portrait" },
    providerErrors: {
        canvasVideoCapabilityUnsupported: "Canvas Open Video API supports video generation only, not {{capability}} generation",
        ...
        shafuDurationUnsupported: "The selected Shafu model does not support {{duration}} seconds. Supported durations: {{supported}}",
        shafuSizeUnsupported: "The selected Shafu model does not support {{size}}. Supported sizes: {{supported}}",
        shafuModelUnsupported: "The Shafu legacy video protocol does not support model {{model}}. Refresh the model list and choose an official model.",
        shafuDurationRange: "Shafu Seedance supports integer durations from 4 to 15 seconds",
        shafuRatioUnsupported: "Shafu Seedance does not support aspect ratio {{ratio}}",
        shafuFrameImageCount: "Shafu frame mode requires one or two reference images",
        shafuFrameMediaUnsupported: "Shafu frame mode does not accept reference video or audio. Select general reference mode.",
        shafuImageCount: "Shafu general reference mode supports up to nine reference images",
        shafuVideoCount: "Shafu general reference mode supports up to three reference videos",
    ...
    version: {
       ...
       updateFailed: "Failed to load the latest version information",
        updateUnavailable: "No update repository is configured",
    ...
    config: {
        ...
        preferences: {
            ...
            publicMediaUpload: "Public media relay",
            publicMediaUploadEnabled: "Upload local assets when a public URL is required",
            publicMediaUploadDescription: "Assets are uploaded only when Zizi Donghua, AutoDL, or Wuhen AI requires public URLs. Existing public URLs and providers supporting local uploads bypass the relay.",
            publicMediaUploadUrl: "Upload endpoint",
            publicMediaUploadToken: "Upload token",
            publicMediaUploadPrivacy: "Standard assets are retained for 24 hours. Wuhen task assets are retained for 48 hours and deleted after the result is saved locally. The relay token is stored in this browser's local configuration.",
            wuhen: "Wuhen AI",
            wuhenEnabled: "Enable subtitle/watermark removal",
            wuhenDescription: "Run Wuhen AI on an existing video node and create a connected result node while processing.",
            wuhenBaseUrl: "API URL",
            wuhenApiKey: "API Key",
            wuhenModel: "Processing tier",
            wuhenStandard: "Standard",
            wuhenPro: "Pro",
            wuhenRetention: "Uses automatic full-frame detection documented by the API. The same operation handles subtitles, text, logos, images, and moving watermarks.",
        },
        channelEditor: {
            title: "Edit provider",
            name: "Provider name",
