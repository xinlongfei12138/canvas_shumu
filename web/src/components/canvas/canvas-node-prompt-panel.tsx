...
function buildNodeConfig(globalConfig: AiConfig, node: CanvasNodeData, mode: CanvasNodeGenerationMode): AiConfig {
    return {
        ...
        videoFaceProcessing: node.metadata?.videoFaceProcessing || globalConfig.videoFaceProcessing || defaultConfig.videoFaceProcessing,
...
function videoConfigPatch(key: keyof AiConfig, value: string) {
    ...
    if (key === "videoNegativePrompt") return { videoNegativePrompt: value };
    if (key === "videoFaceProcessing") return { videoFaceProcessing: value };
    return { [key]: value };
}
