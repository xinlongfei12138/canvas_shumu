...
import { Download, Ellipsis, Eraser, FolderPlus, Image as ImageIcon, Info, MessageSquare, Minus, Music2, Plus, RefreshCw, Settings2, Trash2, Ungroup, Upload, Video } from "lucide-react";
...
type CanvasNodeHoverToolbarProps = {
    ...
    onRemoveSubtitlesWatermark: (node: CanvasNodeData) => void;
...
export function CanvasNodeHoverToolbar({
    ...
    const nodeToolbarTools: ToolbarTool[] = [
        ...
        ...(hasVideo ? [{ id: "removeSubtitlesWatermark", title: t("canvas.nodeToolbar.removeSubtitlesWatermarkTitle"), label: t("canvas.nodeToolbar.removeSubtitlesWatermark"), icon: <Eraser className="size-4" />, onClick: () => onRemoveSubtitlesWatermark(node) }] : []),
